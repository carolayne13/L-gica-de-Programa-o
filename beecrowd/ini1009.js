...
vendedor = prompt("Insira o nome do vendedor: ")
salario = parseFloat(prompt("Insira o salário fixo: "))
vendas = parseFloat(prompt("Insira o total de vendas efetuadas no mês: "))
